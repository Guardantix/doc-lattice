...
func TestEmitAssignmentExtGlobContexts(t *testing.T) {
	tests := []struct {
		...
		{source: `A=*($((1>(2)))|b)`, known: false},
		{source: `A=*($((a[1]<(2)))|b)`, known: false},
		{source: `A=*($((1<( )))|b)`, known: false},
		{source: `A=*($((1+ "<(2)" ))|b)`, known: false},
		{source: "A=*($((1<\\\n(2)))|b)", known: false},
		{source: `A=*(${X:1<(2)}|b)`, known: false},
		{source: `A=*(${X:1:2>(1)}|b)`, known: false},
		{source: "A=*(${X:1<\\\n(2)}|b)", known: false},
		{source: `A=*(${arr[1<(2)]}|b)`, known: false},
		{source: `A=*(${arr[1>(2)]}|b)`, known: false},
		{source: `A=*(${X:-$((1<(2)))}|b)`, known: false},
		{source: "A=*($\\\n[1+2]|b)", known: false},
		...
		{source: `A=*(${X:-<(printf a)}|b)`, known: false, refuse: true},
		{source: `A=*(${X:+>(printf a)}|b)`, known: false, refuse: true},
		{source: `A=*(${X/p/<(printf a)}|b)`, known: false, refuse: true},
		{source: `A=*($"$(printf a)"|b)`, known: false, refuse: true},
		{source: `A=*($[$(printf 1)+1]|b)`, known: false, refuse: true},
		{source: `A=*($(( $(printf 1)+1 ))|b)`, known: false, refuse: true},
		{source: "A=*($[1+`printf 1`]|b)", known: false, refuse: true},
		{source: "A=*($((1+`printf 1`))|b)", known: false, refuse: true},
