...
func TestWalkRefusesOpaqueExtGlobExecutionAndStopsLaterSites(t *testing.T) {
	tests := []struct {
		...
		{name: "modern arithmetic then command", source: `A=*($(( $(doc-lattice check)+1 ))|b) echo outer; echo later`, refuse: true},
		{name: "legacy arithmetic backticks", source: "A=*($[1+`doc-lattice check`]|b) echo outer; echo later", refuse: true},
		{name: "modern arithmetic backticks", source: "A=*($((1+`doc-lattice check`))|b) echo outer; echo later", refuse: true},
		{name: "parameter offset command", source: `A=*(${X:$(doc-lattice check)}|b) echo outer; echo later`, refuse: true},
		{name: "parameter length command", source: `A=*(${X:1:$(doc-lattice check)}|b) echo outer; echo later`, refuse: true},
		{name: "array index command", source: `A=*(${arr[$(doc-lattice check)]}|b) echo outer; echo later`, refuse: true},
		{name: "legacy less comparison", source: `A=*($[1<(2)]|b) echo outer; echo later`},
		{name: "legacy greater comparison", source: `A=*($[1>(2)]|b) echo outer; echo later`},
		{name: "modern less comparison", source: `A=*($((1<(2)))|b) echo outer; echo later`},
		{name: "modern greater comparison", source: `A=*($((1>(2)))|b) echo outer; echo later`},
		{name: "parameter offset comparison", source: `A=*(${X:1<(2)}|b) echo outer; echo later`},
		{name: "parameter length comparison", source: `A=*(${X:1:2>(1)}|b) echo outer; echo later`},
		{name: "array index comparison", source: `A=*(${arr[1<(2)]}|b) echo outer; echo later`},
		{name: "continued arithmetic comparison", source: "A=*($[1<\\\n(2)]|b) echo outer; echo later"},
		{name: "continued modern comparison", source: "A=*($((1<\\\n(2)))|b) echo outer; echo later"},
		{name: "continued parameter comparison", source: "A=*(${X:1<\\\n(2)}|b) echo outer; echo later"},
		{name: "arithmetic nested in parameter word", source: `A=*(${X:-$((1<(2)))}|b) echo outer; echo later`},
		...
		{name: "parameter alternate process", source: `A=*(${X:+>(doc-lattice check)}|b) echo outer; echo later`, refuse: true},
		{name: "parameter replacement process", source: `A=*(${X/p/<(doc-lattice check)}|b) echo outer; echo later`, refuse: true},
		{name: "parameter word nested in arithmetic", source: `A=*($(( ${X:-<(doc-lattice check)} ))|b) echo outer; echo later`, refuse: true},
		{name: "process after quoted arithmetic", source: `A=*("$((1<(2)))"|<(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "process after spaced arithmetic close", source: `A=*($((1) )|<(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "output process after spaced arithmetic close", source: `A=*($((1) )|>(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "process after nested spaced arithmetic close", source: `A=*($(( (1) ) )|<(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "process after tabbed arithmetic close", source: "A=*($((1)\t)|<(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after newline arithmetic close", source: "A=*($((1)\n)|>(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after carriage-return arithmetic close", source: "A=*($((1)\r)|<(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after vertical-tab arithmetic close", source: "A=*($((1)\v)|>(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after form-feed arithmetic close", source: "A=*($((1)\f)|<(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after continued arithmetic close", source: "A=*($((1) \\\n \t)|<(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after combined arithmetic whitespace", source: "A=*($(( (1)\r\v) \f\t)|>(doc-lattice check)) echo outer; echo later", refuse: true},
		{name: "process after arithmetic comparison and spaced close", source: `A=*($((1<(2)) )|<(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "output process after arithmetic comparison and spaced close", source: `A=*($((1>(2)) )|>(doc-lattice check)) echo outer; echo later`, refuse: true},
		{name: "length index command", source: `A=*(${#arr[$(doc-lattice check)]}|b) echo outer; echo later`, refuse: true},
