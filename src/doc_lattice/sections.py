...
# operates on codepoints, not UTF-16 code units. Verified codepoint-for-codepoint over Unicode
# scalar values against github-slugger@2.0.0; repeat that parity check when updating this table.
